;(function () {
	...
	$('a[href*="#"]:not([href="#"])').on('click', function() {
	    if (location.pathname.replace(/^\//,'') == this.pathname.replace(/^\//,'') && location.hostname == this.hostname) {
	    	...
	    	//simple function to know whether to run this scrollspy.
	    	if($(this).hasClass("nav-course-selector")){
	    		console.log("ignoring scrollspy");
	    		return;
	    	}
	    	console.log("making sure it doesn't run here");
